...
class ACWst(enum.Enum):
    """Wind Strength."""
    F00 = "@AC_MAIN_WIND_STRENGTH_SLOW_W"
    F0 = "@AC_MAIN_WIND_STRENGTH_SLOW_LOW_W"
    F1 = "@AC_MAIN_WIND_STRENGTH_LOW_W"
    F2 = "@AC_MAIN_WIND_STRENGTH_LOW_MID_W"
    F3 = "@AC_MAIN_WIND_STRENGTH_MID_W"
    F4 = "@AC_MAIN_WIND_STRENGTH_MID_HIGH_W"
    F5 = "@AC_MAIN_WIND_STRENGTH_HIGH_W"
    FF = "@AC_MAIN_WIND_STRENGTH_POWER_W"
    AI = "@AC_MAIN_WIND_STRENGTH_AUTO_W"
